...
<a class="edit-button" href="frontController.php?controller=profil&action=modification&idUtilisateur=<?php echo($user->getIdentifiant()); ?>" >Modifier profil : <img id="edit-img" src="assets/logo/modif.png"></a>
