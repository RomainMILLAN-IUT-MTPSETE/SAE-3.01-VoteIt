...
<form id="form" class="formulaire--container" action="frontController.php?controller=reponses&action=updated" method="post" autocomplete="off">
    <div class="formulaire-template">
        ...
        <div class="autocomplete" id="co-auteur-container">
            ...
            <input type="text" id="userCoAuteur" placeholder="johndoe10@gmail.com" value="<?php echo(htmlspecialchars($coauteurStr)) ?>">
        </div>
